  ...
  describe Capabilities do
    describe '#new' do
      ...
      describe ':driver' do
        ...
        it 'is nil if :url parameter is set' do
      ...
      describe ':http_client' do
        it 'does not create default http client settings' do
          expect(capabilities.http_client).to be_a(Hash)
          expect(capabilities.http_client).to be_empty
        end
        ...
        it 'accepts Selenium::WebDriver::Remote::Http::Default instance' do
          timeouts = {open_timeout: 10, read_timeout: 10}
      ...
      describe ':proxy' do
        ...
        it 'accepts Selenium::WebDriver::Proxy instance' do
          ...
          expect(capabilities.proxy[:type]).to eq :auto_detect
          expect(capabilities.proxy[:auto_detect]).to eq true
        end
      end
      ...
      describe ':options' do
        it 'accepts Selenium Browser Options class instances' do
      ...
      describe ':firefox' do
        it 'accepts provided values' do
          ...
          browser_options = {# http://peter.sh/experiments/chromium-command-line-switches/
                             ...
                             # TODO: Provide option for adding extensions independently
                             profile: ''}
